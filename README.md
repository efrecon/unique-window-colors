...
To install, run `yarn package`to package the extension into a _.vsix_ file. Then, in VS Code, open the "Extensions" tab, click on the three dots in the top right corner, click on "Install from VSIX..." and select the file you just created.
